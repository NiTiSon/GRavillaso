...
public class GRLoadouts implements ContentList {
    ...
    public void load() {
        ...
        Vars.schematics.getLoadouts().put(GRBlocks.molecularCore, Seq.with(basicMolecular));
        Vars.schematics.getLoadouts().put(GRBlocks.coliseumCore, Seq.with(basicColiseum));
    }
}
